...
# SQL command to insert data into the database
sql_command ="""INSERT INTO distance (LocationID, Location1, Location2, Location3, Location4, Location5, Location6, Location7, Location8, Location9, Location10)
VALUES
    (1, 0, 63256, 97868, 97868, 97868, 97868, 97868, 97868, 97868, 97868),
    (2, 63256, 0, 8, 3, 2, 6, 8, 4, 8, 8),
    (3, 97868, 8, 0, 11, 10, 6, 3, 9, 5, 3),
    (4, 97868, 3, 11, 0, 1, 7, 10, 6, 10, 10),
    (5, 97868, 2, 10, 1, 0, 6, 9, 4, 8, 9),
    (6, 97868, 65, 6, 7, 6, 0, 2, 3, 2, 2),
    (7, 97868, 8, 3, 10, 9, 2, 0, 6, 2, 5),
    (8, 97868, 43, 9, 6, 4, 3, 6, 0, 4, 4),
    (9, 97868, 8, 5, 10, 8, 2, 2, 4, 0, 3),
    (10, 97868, 8, 8, 10, 9, 2, 5, 4, 3, 0);
"""
